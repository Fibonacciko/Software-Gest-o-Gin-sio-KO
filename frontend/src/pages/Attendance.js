...
const Attendance = ({ language, translations }) => {
  ...
  const getAttendanceStats = () => {
    ...
    const currentMonthAttendance = attendance.filter(att => {
      const attendanceDate = new Date(att.check_in_date);
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <div className="flex items-center space-x-2">
                                <p className="font-medium">{att.member ? att.member.name : 'Membro eliminado'}</p>
                              ...
                              <p className="text-sm text-gray-500">{att.member ? att.member.phone : 'N/A'}</p>
                            </div>
                          </div>
                        </td>
                        <td className="p-4">
