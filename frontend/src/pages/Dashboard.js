...
const Dashboard = ({ language, translations }) => {
  ...
  const t = {
    pt: {
      ...
      membershipAnniversaries: 'Aniversários de Adesão',
      today: 'Hoje',
      birthdayToday: 'faz anos hoje!',
      completesYear: 'aniversário de adesão!',
      year: 'ano',
      years: 'anos',
      noBirthdays: 'Nenhum aniversário hoje',
      noAnniversaries: 'Nenhum aniversário de adesão hoje',
      yearsOld: 'anos',
    ...
    en: {
      ...
      alerts: 'Alerts',
      birthdays: 'Birthdays',
      membershipAnniversaries: 'Membership Anniversaries',
      today: 'Today',
      birthdayToday: 'birthday today!',
      completesYear: 'membership anniversary!',
      year: 'year',
      years: 'years',
      noBirthdays: 'No birthdays today',
      noAnniversaries: 'No membership anniversaries today',
      yearsOld: 'years old',
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const sortedAttendance = attendanceWithMembers.sort((a, b) => {
        return new Date(b.check_in_date + ' ' + b.check_in_time) - new Date(a.check_in_date + ' ' + a.check_in_time);
      });
      
      // Show all check-ins (allow multiple check-ins per member per day)
